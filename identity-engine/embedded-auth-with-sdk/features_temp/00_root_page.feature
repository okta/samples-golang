...
Feature: 0.1 Root page for Direct Auth Demo Application
  ...
  @0.1.1
  Scenario: 0.1.1 Mary visits the Root View WITHOUT an authentication session (no tokens)
  ...
  @0.1.2
  Scenario: 0.1.2 Mary visits the Root View and WITH an authentication session
    Given Mary navigates to the Root View
